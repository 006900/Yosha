...
fun MainScreen(){
    ...
    val dataMode = DataStoreUtil(LocalContext.current)
    val modeView by dataMode.modeView.collectAsState(initial = false)
    ...
    Box(
        ...
        if (tokenText.value.isBlank()){imageUri?.let {
            ...
            GlideImage(model = tokenText.value,
                contentDescription = null,
                contentScale = if (imageSize){ ContentScale.FillBounds}
            ...
            Column(
                ...
                Text(
                    ...
                    color = when(colorTextTop.value){
                        ...
                        "cyan_a400"->{cyan_a400}
                        "cyan_a700"->{cyan_a700}
                        "deep_purple_050"->{deep_purple_050}
                        ...
                        "deep_orange_050"->{deep_orange_050}
                        ...
                        "grey_800"->{grey_800}
                        "grey_900"->{grey_900}
                        "grey_1000_b"->{grey_1000_b}
                        "grey_1000_w"->{grey_1000_w}
                        "green_050"->{green_050}
                        "green_100"->{green_100}
                        "green_200"->{green_200}
                        "green_300"->{green_300}
                        ...
                        "light_green_050"->{light_green_050}
