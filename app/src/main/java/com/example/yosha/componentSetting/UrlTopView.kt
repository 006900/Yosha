...
fun UrlTop() {
    ...
    val contextTop = LocalContext.current
    val storeTop = DataStoreUtil(contextTop)
    ...
    Card(
        ...
        Row(
            ...
            OutlinedTextField(modifier = Modifier.size(height = 50.dp, width = 260.dp),
                value = urlTop.value, onValueChange = { urlTop.value = it },
                placeholder = { Text(text = "topView...", color = Color.LightGray) },
            ...
            Box(
                ...
                Row {
                    ...
                    IconButton(onClick = { urlTop.value= TextFieldValue() }) {
                        Icon(
                    ...
                    IconButton(onClick = {
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            storeTop.saveTop(urlTop.value.text)
                        }
                    }) {
                        Icon(
